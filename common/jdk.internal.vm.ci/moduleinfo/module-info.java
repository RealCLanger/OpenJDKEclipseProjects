...
module jdk.internal.vm.ci {
    ...
    exports jdk.vm.ci.aarch64 to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.amd64 to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.code to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.code.site to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.code.stack to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.common to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.hotspot to jdk.internal.vm.compiler,
        jdk.aot;
    exports jdk.vm.ci.hotspot.aarch64 to jdk.internal.vm.compiler,
        jdk.aot;
